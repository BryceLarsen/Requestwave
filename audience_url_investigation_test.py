...
class AudienceURLInvestigator:
    def __init__(self):
        ...
        self.backend_url = os.getenv('REACT_APP_BACKEND_URL', 'https://bulk-charts.preview.emergentagent.com')
    ...
    def test_environment_variables(self) -> Dict[str, Any]:
        ...
        try:
            ...
            expected_backend = "https://bulk-charts.preview.emergentagent.com"
