...
async def test_audience_id_stored_on_request(test_musician, test_show, test_song, test_db):
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        # Cleanup
        await test_db.requests.delete_one({"id": request_id})
...
async def test_audience_id_stored_on_tip(test_musician, test_show, test_db):
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        # Cleanup
        await test_db.tips.delete_one({"id": tip_id})
...
async def test_tip_clicked_event_has_correct_context(test_musician, test_show, test_song, test_db):
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        # Cleanup
        await test_db.requests.delete_one({"id": request_id})
        await test_db.analytics_events.delete_one({"id": event["id"]})
...
async def test_dedication_event_fires_when_dedication_present(test_musician, test_show, test_song):
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        # Cleanup
        await test_db.requests.delete_one({"id": request_id})
        await test_db.analytics_events.delete_many({"entity_id": request_id})
