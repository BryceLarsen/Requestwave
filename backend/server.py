...
async def create_upgrade_checkout(
    ...
    """Create Stripe checkout session for Pro subscription - Choose between monthly ($10) or annual ($60) plans"""
    if not STRIPE_API_KEY:
        raise HTTPException(status_code=500, detail="Stripe not configured")
    
    try:
        # Initialize Stripe - use environment variable for base URL
        base_url = os.environ.get('FRONTEND_URL', 'https://c9aa150a-6f2f-42af-9179-ded9ed77f946.preview.emergentagent.com')
