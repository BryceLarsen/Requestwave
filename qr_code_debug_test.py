...
The user reports:
- Frontend audience URL: https://tipper-interface.preview.emergentagent.com/musician/bryce-larsen (working)
...
class QRCodeDebugTester:
                ...
                if audience_url:
                    ...
                    if '/musician/' in audience_url:
                        ...
                        if 'livewave-music.emergent.host' in base_url:
                            ...
                            print(f"   📊 Expected URL should be: https://tipper-interface.preview.emergentagent.com")
            ...
            if self.musician_slug:
                ...
                if musician_qr_response.status_code == 200:
                    ...
                    if musician_audience_url:
                        ...
                        expected_url = f"https://tipper-interface.preview.emergentagent.com/musician/{self.musician_slug}"
    ...
    def test_frontend_url_detection(self):
        ...
        try:
            ...
            expected_frontend_url = f"https://tipper-interface.preview.emergentagent.com/musician/{self.musician_slug}"
    ...
    def run_all_investigations(self):
        ...
        print("   Expected: https://tipper-interface.preview.emergentagent.com")
