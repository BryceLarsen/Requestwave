...
PREVIEW_BACKEND_URL = "https://requestwave-fix.preview.emergentagent.com/api"
PREVIEW_FRONTEND_URL = "https://requestwave-fix.preview.emergentagent.com"
...
class FrontendBackendFlowTester:
    ...
    def test_frontend_environment_variables(self):
        ...
        expected_backend_url = "https://requestwave-fix.preview.emergentagent.com"
